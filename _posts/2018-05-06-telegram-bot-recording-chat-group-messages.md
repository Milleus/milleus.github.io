...
On a random day while having a morning shower, I started to wonder how easy would it be to set up a Telegram bot to listen and store all chat group messages. Why I had this thought? I'm not sure, but anyway I went ahead with a "collect first and think later" approach just like any other data hoarder would.
...
**11 AM** - I added the bot to multiple chat groups telling people that I'm "testing something", which technically I am! I sit back, relax, look at the data flowing into my spreadsheet, and contemplate on what to do with this new found power.
